...
import { setLeftRange, setRange } from "../../features/products/products";

export const ProductSection = () => {
  const { range, rangeLeft, category, allData } = useSelector(
  ...
  const applyRange = () => {
    dispatch(setRange(tempRange));
    dispatch(setLeftRange(tempLeftRange));
  };

  ...
  return (
    ...
    >
      ...
      <div className="px-5 sm:px-20 lg:px-45">
        <div className="grid sm:grid-cols-[repeat(auto-fill,minmax(190px,230px))] auto-rows-[450px] sm:auto-rows-[350px] justify-center sm:justify-between lg:justify-between gap-15 mb-30">
          <div className="bg-[#956943] rounded-3xl flex flex-col items-center text-white">
            <div className="h-[250px] sm:h-[170px] min-w-[190px] max-w-[270px] rounded-t-3xl flex justify-center overflow-hidden">
              <img
                loading="lazy"
                className="h-[250px] sm:h-[170px] object-cover"
                src="/expresso.webp"
                alt="expresso"
              />
            </div>
            <span className="text-white text-3xl sm:text-xl mt-2">
              Espresso
            </span>
            <span className="text-white text-lg sm:text-sm mt-0.1 font-light text-center">
              Strong & bold shot
            </span>
          ...
          <div className="bg-[#956943] rounded-3xl flex flex-col items-center text-white">
            ...
            <span className="text-white text-3xl sm:text-xl mt-2">Latte</span>
            <span className="text-white text-lg sm:text-sm mt-0.1 font-light text-center">
              Creamy & rich flavor
            </span>
            <span className="text-black text-xl mt-2 font-semibold text-center">
          ...
          <div className="bg-[#956943] rounded-3xl flex flex-col items-center text-white">
            ...
            <span className="text-white text-3xl sm:text-xl mt-2">Mocha</span>
            <span className="text-white text-lg sm:text-sm mt-0.1 font-light text-center">
          ...
          <div className="bg-[#956943] rounded-3xl flex flex-col items-center text-white">
            <div className="h-[250px] sm:h-[170px] min-w-[190px] max-w-[270px] rounded-t-3xl flex justify-center overflow-hidden">
              <img
                loading="lazy"
                className="h-[250px] sm:h-[170px] object-cover object-top"
                src="/coldBrew.webp"
                alt="cold brew"
              />
            </div>

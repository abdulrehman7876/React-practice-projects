export default function Home() {
  return (
    <section id="home" className="h-screen bg-home bg-cover flex relative">
      <div className="w-screen sm:w-full h-screen absolute bg-[url('c.webp')] bg-cover bg-no-repeat bg-center z-0"></div>
      <div className="relative flex flex-col text-white px-5 sm:px-20 lg:px-45 gap-2 top-50">
        ...
        <span className="text-gray-200 bg-[#956943]/1 backdrop-blur-sm text-xl sm:text-lg w-85 sm:w-70 text-justify">
